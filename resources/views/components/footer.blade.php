    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      ...
      <div class="space-y-4" data-aos="fade-up" data-aos-delay="300">
        ...
        <div class="flex space-x-4">
          ...
          <a href="#" 
            class="w-10 h-10 bg-gray-800/10 text-gray-800 rounded-full flex items-center justify-center hover:bg-gray-800 hover:text-white transition-all duration-300 hover:scale-110">
            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    <div class="mt-12 pt-8 border-t border-base-content/10">
      <div class="text-center">
        <p class="text-base-content/60">
          &copy; {{ date('Y') }} EXAMPLE.ID. All rights reserved. 
